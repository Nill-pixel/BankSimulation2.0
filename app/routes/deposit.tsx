...
import { deposit, getAccount } from "~/utils/account.server";
...
export const action: ActionFunction = async ({ request }) => {
    ...
    switch (action) {
        case 'deposit': {
            ...
            return await deposit(account, balanceValue)
        }
        default: {
            return json({ error: `Invalid form data`, form: action }, { status: 403 })
        }
                    ...
                    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
                        <div className="text-center">
                            ...
                            <p className="mt-3 text-gray-600 dark:text-gray-400">
                                Securely grow your savings with us – deposit your money today and watch your financial future flourish
                            </p>
